...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktest58"] = self["webpackChunktest58"] || [];
...
;// ./simulator/remotion/templates/classic-template.tsx
...
const ClassicTemplate = ({
  ...
  const { fps: videoFps, durationInFrames } = (0,esm.useVideoConfig)();
  ...
  if (!ayahs || !Array.isArray(ayahs) || ayahs.length === 0) {
    return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: {
      ...
      justifyContent: "center",
      alignItems: "center"
    } }, /* @__PURE__ */ React.createElement("div", { style: { color: "white", fontSize: 32 } }, "No ayahs provided"));
  }
  ...
  const getFramesForAyah = (index) => {
    const duration = audioDurations == null ? void 0 : audioDurations[index];
    return duration ? Math.round(duration * fps) : 8 * fps;
  };
  const framesPerAyah = getFramesForAyah(0);
  const closingDuration = closingDurationSeconds * fps;
  const fadeTransitionDuration = Math.floor(fps * 0.8);
  const getFloatingAnimation = (index, multiplier = 1) => {
    return Math.sin((frame + index * 30) * 0.02) * 3 * multiplier;
  };
  const getParallaxOffset = (depth) => {
    return Math.sin(frame * 0.01) * depth;
  };
  const getDynamicScale = (startFrame, intensity = 0.05) => {
  ...
  const renderParticles = () => {
    const particles = [];
    for (let i = 0; i < 15; i++) {
      const particleProgress = (frame + i * 20) * 8e-3;
      const x = (0,esm.random)(`particle-x-${i}`) * 1920 + Math.sin(particleProgress) * 100;
      const y = (0,esm.random)(`particle-y-${i}`) * 1080 + Math.cos(particleProgress * 0.7) * 50;
      const opacity = (Math.sin(particleProgress) + 1) * 0.15;
      const size = (0,esm.random)(`particle-size-${i}`) * 4 + 2;
      particles.push(
  ...
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, null, backgroundVideoUrl ? /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { zIndex: 0, pointerEvents: "none", overflow: "hidden" } }, /* @__PURE__ */ React.createElement(
    "img",
    {
    ...
    esm.AbsoluteFill,
    {
      style: {
        background: `
              radial-gradient(circle at ${50 + Math.sin(frame * 5e-3) * 20}% ${50 + Math.cos(frame * 3e-3) * 15}%, 
    ...
    esm.AbsoluteFill,
    {
      style: {
        background: `
          ...
          `,
        transform: `rotate(${Math.sin(frame * 8e-3) * 2}deg) scale(${1 + Math.sin(frame * 6e-3) * 0.02})`
      }
    }
  ), /* @__PURE__ */ React.createElement(esm.AbsoluteFill, null, renderParticles()), /* @__PURE__ */ React.createElement(
    esm.AbsoluteFill,
    {
      style: {
        background: `
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(esm.Audio, { src: currentAudioUrl })
    );
  }), titleDuration > 0 && /* @__PURE__ */ React.createElement(esm.Sequence, { from: 0, durationInFrames: Math.min(titleDuration, durationInFrames) }, /* @__PURE__ */ React.createElement(
    esm.AbsoluteFill,
    {
      style: {
        justifyContent: "center",
    ...
    /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          ...
          transform: `
                  translateY(${(0,esm.interpolate)(frame, [0, titleDuration], [50, 0], {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        ((_b = (_a = ayahs[0]) == null ? void 0 : _a.surah) == null ? void 0 : _b.englishName) || "Quran Verses"
      ),
      /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            width: (0,esm.interpolate)(frame, [titleDuration * 0.5, titleDuration], [0, 300], {
    ...
    const actualSequenceDuration = Math.min(framesPerAyah2, durationInFrames - sequenceStart);
    ...
    const fadeOutProgress = isFadingOut ? Math.min((sequenceFrame - fadeOutStart) / fadeOutFrames, 1) : 0;
    const entranceFrames = fadeTransitionDuration * 1.5;
    const translateY = sequenceFrame < entranceFrames ? (0,esm.interpolate)(sequenceFrame, [0, entranceFrames], [60, 0], { easing: esm.Easing.out(esm.Easing.cubic) }) : 0;
    return /* @__PURE__ */ React.createElement(
      esm.Sequence,
      {
        key: `ayah-${((_a2 = ayah.surah) == null ? void 0 : _a2.number) || "surah"}-${ayah.number || index}`,
        from: sequenceStart,
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          ayah.translation && /* @__PURE__ */ React.createElement(
            "div",
            {
              style: {
                fontSize: 32,
    ...
    if (closingStart < durationInFrames && actualClosingDuration > 0) {
      return /* @__PURE__ */ React.createElement(esm.Sequence, { from: closingStart, durationInFrames: actualClosingDuration }, /* @__PURE__ */ React.createElement(
        esm.AbsoluteFill,
        {
          style: {
            justifyContent: "center",
...
;// ./simulator/remotion/templates/modern-template.tsx
...
const ModernTemplate = ({
  ...
  if (!ayahs || !Array.isArray(ayahs) || ayahs.length === 0) {
    return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: {
      ...
      justifyContent: "center",
      alignItems: "center"
    } }, /* @__PURE__ */ React.createElement("div", { style: { color: themeColor || "white", fontSize: 32 } }, "No ayahs provided"));
  }
  const fps = config.fps || videoFps || 30;
  ...
  const getFramesForAyah = (index) => {
    const duration = audioDurations == null ? void 0 : audioDurations[index];
    return duration ? Math.round(duration * fps) : 10 * fps;
  };
  const closingDuration = closingDurationSeconds * fps;
  const fadeTransitionDuration = Math.floor(fps * 0.8);
  const getSubtleFloat = (amplitude, frequency, offset = 0) => {
    return Math.sin((frame + offset) * frequency) * amplitude;
  };
  console.log("audioDurations", audioDurations);
  console.log("ayahs", ayahs);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { backgroundColor } }, backgroundVideoUrl && /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { zIndex: 0, pointerEvents: "none", overflow: "hidden" } }, /* @__PURE__ */ React.createElement(
    "img",
    {
      src: backgroundVideoUrl,
      style: {
    ...
    /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          ...
          transform: `
                  translateY(${(0,esm.interpolate)(frame, [0, titleDuration], [40, 0], {
            easing: esm.Easing.out(esm.Easing.cubic)
          })}px)
                `
        }
      ...
      /* @__PURE__ */ React.createElement(
        ...
        ((_b = (_a = ayahs[0]) == null ? void 0 : _a.surah) == null ? void 0 : _b.englishName) || "Sacred Verses"
      ),
      /* @__PURE__ */ React.createElement(
        "div",
        {
        ...
        "Surah ",
        (_e = (_d = (_c = ayahs[0]) == null ? void 0 : _c.surah) == null ? void 0 : _d.number) == null ? void 0 : _e.toString().padStart(3, "0")
      )
    )
  )), ayahs.map((ayah, index) => {
    var _a2, _b2;
    ...
    const fadeOutProgress = isFadingOut && fadeOutFrames > 0 ? Math.min((sequenceFrame - fadeOutStart) / fadeOutFrames, 1) : 0;
    const fadeInFrames = fadeTransitionDuration;
    const isFadingIn = sequenceFrame < fadeInFrames;
    const fadeInProgress = isFadingIn && fadeInFrames > 0 ? Math.min(sequenceFrame / fadeInFrames, 1) : 1;
        ...
        /* @__PURE__ */ React.createElement(
          ...
          ayah.translation && /* @__PURE__ */ React.createElement(
            "div",
            {
              style: {
                ...
                opacity: opacity * 0.9,
                transform: `
                        translateY(${getSubtleFloat(3, 8e-3, index * 150 + 50)}px)
                      `
              }
            },
            ayah.translation
          ...
          /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
              ...
              (_b2 = ayah.numberInSurah) == null ? void 0 : _b2.toString().padStart(2, "0")
            )
          )
        )
      )
        ...
        /* @__PURE__ */ React.createElement(
          "div",
          {
            style: {
              ...
              transform: `
                      translateY(${(0,esm.interpolate)(closingFrame, [0, actualClosingDuration * 0.5], [30, 0])}px)
                    `
            }
          },
          /* @__PURE__ */ React.createElement(
            ...
            "\xD8\xB5\xD8\xAF\xD9\u201A \xD8\xA7\xD9\u201E\xD9\u201E\xD9\u2021 \xD8\xA7\xD9\u201E\xD8\xB9\xD8\xB8\xD9\u0160\xD9\u2026"
          ),
          /* @__PURE__ */ React.createElement(
            "div",
            {
...
;// ./simulator/remotion/templates/capcut-template.tsx
...
const CapcutTemplate = ({
  ...
  const frame = (0,esm.useCurrentFrame)();
  const { fps: videoFps, durationInFrames } = (0,esm.useVideoConfig)();
  const themeColor = config.themeColor || legacyThemeColor || "#D4AF37";
  const backgroundColor = config.backgroundColor || legacyBackgroundColor || "#0A1F3C";
  const backgroundVideoUrl = config.backgroundVideoUrl;
  const audioUrl = config.audioUrl || legacyAudioUrl;
  if (!ayahs || !Array.isArray(ayahs) || ayahs.length === 0) {
    return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: {
  ...
  const closingDuration = closingDurationSeconds * fps;
  const transitionDuration = Math.floor(fps * 1);
  console.log("audioDurations", audioDurations);
  console.log("ayahs", ayahs);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { backgroundColor, overflow: "hidden" } }, backgroundVideoUrl && /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { style: { zIndex: 0, pointerEvents: "none", overflow: "hidden" } }, /* @__PURE__ */ React.createElement(
    "img",
    {
      src: backgroundVideoUrl,
      style: {
    ...
    /* @__PURE__ */ React.createElement("div", { style: {
      ...
      // Softer, larger glow
      opacity: (0,esm.spring)({ frame, fps, config: { mass: 1, damping: 15, stiffness: 100 } })
      // Smoother spring
    } }),
    /* @__PURE__ */ React.createElement(
      "div",
      ...
      /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            ...
            fontFamily: "Georgia, serif",
            // Serif font
            opacity: (0,esm.spring)({ frame: Math.max(0, frame - titleDuration * 0.4), fps, config: { mass: 1, damping: 15, stiffness: 100 } }),
          ...
          /* @__PURE__ */ React.createElement(
            "div",
            {
              style: {
                ...
                // Specific elegant Quranic font if available, fallback
                fontWeight: "normal",
                // Standard weight often looks better
                color: "#FFF",
                lineHeight: 2,
...
;// ./simulator/remotion/Root.tsx





const calculateVideoDuration = (ayahs, config = {}, audioDurations = []) => {
  const titleDuration = config.titleDuration || 2;
  const closingDuration = config.closingDuration || 1;
  const fps = config.fps || 30;
  const totalAyahSeconds = audioDurations.length === ayahs.length ? audioDurations.reduce((sum, dur) => sum + (dur || 8), 0) : ayahs.length * (config.ayahDuration || 8);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    esm.Composition,
    {
      ...
      defaultProps: {
        ...
        audioDurations: defaultAyahs.map((ayah) => ayah.audioDuration || 8)
        // <-- pass this!
      },
      calculateMetadata: ({ props }) => {
        ...
        return {
          durationInFrames: actualDuration.durationInFrames,
          fps: (config == null ? void 0 : config.fps) || 30,
          width: (config == null ? void 0 : config.width) || 1920,
          height: (config == null ? void 0 : config.height) || 1080
        };
      }
    }
  ), /* @__PURE__ */ React.createElement(
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 65).then(__webpack_require__.bind(__webpack_require__, 9065)).then(({ StudioInternals }) => {
